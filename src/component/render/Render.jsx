...
function section(args) {
    ...
    if (args.title) {
        title = <span className="form-label">{args.title}</span>
    }
...
function field(bf) {
    ...
    if (bf.label) {
        var labelClass = bf.field.cssClass ? bf.field.cssClass :"form-label"
        fieldName = <label htmlFor={bf.autoId()} className={labelClass}>{bf.label}</label>
    }
